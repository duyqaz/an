...
<!-- Mirrored from template.hasthemes.com/shome/shome/shop-checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Nov 2023 06:03:50 GMT -->
<head>
    <meta charset="utf-8">
                  ...
                  <div class="header-info-items">
                    <div class="info-items">
                      <ul>
                        ...
                        <li class="account"><i class="fa fa-user"></i><a href="../view/taikhoan/dangky.php">Đăng Ký</a></li>
                        <li class="account"><i class="fa fa-user"></i><a href="account-login.html">Đăng Nhập</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div class="header-middle-align">
                <div class="header-middle-align-start">
                  <div class="header-logo-area">
                    <a href="index.html">
                      <img class="logo-main" src="../view/img/logo.webp" width="131" height="34" alt="Logo" />
                      <img class="logo-light" src="../view/img/logo-light.webp" width="131" height="34" alt="Logo" />
                    </a>
                  </div>
                </div>
                  ...
                  <div class="header-action-area">
                    ...
                    <div class="shopping-cart">
                      <button class="shopping-cart-btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#AsideOffcanvasCart" aria-controls="offcanvasRightLabel">
                        <a href="../view/bii/bill.php ">
                          <i class="pe-7s-shopbag icon">
              ...
              <div class="header-align">
                <div class="header-navigation-area position-relative">
                  <ul class="main-menu nav">
                    <li class=""><a href="index.php"><span>Trang Chủ</span></a>
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="checkout-billing-details-wrap">
              <h2 class="title">Chi tiết thanh toán</h2>
              <div class="billing-form-wrap">
                <form action="#" method="post">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="f_name">Tên <abbr class="required" title="required">*</abbr></label>
                        <input id="f_name" type="text"  class="form-control">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="l_name">Họ <abbr class="required" title="required">*</abbr></label>
                        <input id="l_name" type="text"  class="form-control">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="com_name">Tên công ty (nếu có)</label>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="street-address">Địa chỉ <abbr class="required" title="required">*</abbr></label>
                        <input id="street-address" type="text"  class="form-control" placeholder="Số nhà và tên đường">
                      </div>
                      <div class="form-group">
                        <label for="street-address2" class="visually-hidden">Street address 2 <abbr class="required" title="required">*</abbr></label>
                        <input id="street-address2" type="text"  class="form-control" placeholder="Cănf hộ ,dãy phòng, ( Tùy chọn) ">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="town">Thị trấn / Thành phố  <abbr class="required" title="required">*</abbr></label>
                        <input id="town" type="text"  class="form-control">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="district">Huyện <abbr class="required" title="required">*</abbr></label>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="phone">Điện thoại (tùy chọn)</label>
                        <input id="phone" type="text"  class="form-control">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group" data-margin-bottom="30">
                        <label for="email">Địa chỉ email  <abbr class="required" title="required">*</abbr></label>
          ...
          <div class="col-lg-6">
            ...
            <div class="checkout-order-details-wrap">
              <div class="order-details-table-wrap table-responsive">
                <h2 class="title mb-25">Đơn Hàng</h2>
                <table class="table">
                  <thead>
                    <tr>
                ...
                <div class="shop-payment-method">
                  <div id="PaymentMethodAccordion">
                    ...
                    <div class="card">
                      <div class="card-header" id="check_payments4">
                        <h5 class="title" data-bs-toggle="collapse" data-bs-target="#itemFour" aria-controls="itemTwo" aria-expanded="false">PayPal Express Checkout <img src="../img/photos/paypal2.webp" width="40" height="26" alt="Image-HasTech"></h5>
                      </div>
                  ...
                  <p class="p-text">Dữ liệu cá nhân của bạn sẽ được sử dụng để xử lý đơn đặt hàng, hỗ trợ trải nghiệm của bạn trên trang web này và cho các mục đích khác được mô tả trong<a href="#/">chính sách bảo mật của chúng tôi.</a></p>
...
<!-- Mirrored from template.hasthemes.com/shome/shome/shop-checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Nov 2023 06:03:51 GMT -->
</html>