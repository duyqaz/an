...
<!-- Mirrored from template.hasthemes.com/shome/shome/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Nov 2023 06:03:01 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--== Swiper CSS ==-->
    <link href="../view/css/swiper.min.css" rel="stylesheet" />
    <!--== Fancybox Min CSS ==-->
    <link href="../view/css/fancybox.min.css" rel="stylesheet" />
    <!--== Aos Min CSS ==-->
    <link href="../view/css/aos.min.css" rel="stylesheet" />
              ...
              <div class="header-middle-align-end">
                <div class="header-action-area">
                  ...
                  <div class="shopping-wishlist">
                    <a class="shopping-wishlist-btn" href="shop-cart.html">
            ...
            <div class="header-align">
              <div class="header-navigation-area position-relative">
                <ul class="main-menu nav">
                  <li class=""><a href="index.html"><span>Trang Chủ</span></a>
                  ...
                  <li class="has-submenu position-static"><a href="shop-four-columns.html"><span>Sản Phẩm</span></a>
      ...
      <div class="swiper-container home-slider-container default-slider-container">
        <div class="swiper-wrapper home-slider-wrapper slider-default">
          <div class="swiper-slide">
            <div class="slider-content-area" data-bg-img="../view/img/shape/1.webp">
              <div class="container">
                    ...
                    <div class="col-sm-6 col-md-6">
                      <div class="slider-thumb">
                        <div class="thumb scene">
                          <span class="scene-layer" data-depth=".3"><img src="../view/img/slider/slider-01.webp" width="461" height="489" alt="Image-HasTech"></span>
                        </div>
                        <div class="shape-group mousemove">
                          <div class="shape-group-one mousemove-layer" data-speed=".8" data-bg-img="../view/img/shape/2.webp"></div>
                          <div class="shape-group-two scene"><span class="scene-layer" data-depth=".6"><img src="../view/img/shape/3.webp" width="471" height="462" alt="Image-HasTech"></span></div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="slider-container">
                  <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-sm-6 col-md-6">
                      <div class="slider-thumb">
                        <div class="thumb scene">
                          <span class="scene-layer" data-depth=".3"><img src="../view/img/slider/slider-03.webp" width="548" height="649" alt="Image-HasTech"></span>
                        </div>
                        <div class="shape-group mousemove">
                          <div class="shape-group-one mousemove-layer" data-speed=".8" data-bg-img="../view/img/shape/2.webp"></div>
                          <div class="shape-group-two scene"><span class="scene-layer" data-depth=".6"><img src="../view/img/shape/3.webp" width="471" height="462" alt="Image-HasTech"></span></div>
          ...
          <div class="col-lg-4 col-md-6">
            ...
            <div class="product-collection">
              <div class="inner-content">
                ...
                <div class="product-collection-thumb" data-bg-img="../view/img/shop/collection/1.webp"></div>
          ...
          <div class="col-lg-4 col-md-6">
            ...
            <div class="product-collection">
              <div class="inner-content">
                ...
                <div class="product-collection-thumb" data-bg-img="../view/img/shop/collection/2.webp"></div>
                <a class="banner-link-overlay" href="shop.html"></a>
              </div>
            </div>
            <!--== End Product Collection Item ==-->
          ...
          <div class="col-lg-4 col-md-6">
            ...
            <div class="product-collection">
              <div class="inner-content">
                ...
                <div class="product-collection-thumb" data-bg-img="../view/img/shop/collection/3.webp"></div>
                <a class="banner-link-overlay" href="shop.html"></a>
              </div>
            </div>
            <!--== End Product Collection Item ==-->
